...
public class CacheManager {
  ...
  // ===== 云端物资缓存（内存级，App关闭后失效） =====
  private static String cachedCloudItemsRaw = null;

  public static String getCachedCloudItems() {
    return cachedCloudItemsRaw;
  }

  public static void setCachedCloudItems(String raw) {
    cachedCloudItemsRaw = raw;
  }

  public static boolean hasCloudItemsCached() {
    return cachedCloudItemsRaw != null && !cachedCloudItemsRaw.isEmpty();
  }
}

...
public final class ThemeManager {
  ...
  public static final class Theme {
    ...
    public final int grad, grad3;   // 渐变搭档色（按钮/液体球/进度条多色渐变的第二、三色，相近色相）
    public final int text, sub;     // 主文字 / 次级文字
    public final int glass, border; // 玻璃底色 / 玻璃高光描边
    public final int chipBg;        // 浅色标签底（原 tagColor 语义）

    public Theme(int w1, int w2, int w3, int acc, int grad, int grad3, int text, int sub, int glass, int border, int chipBg) {
